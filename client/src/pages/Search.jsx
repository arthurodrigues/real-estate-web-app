  ...
  return (
    <div className='flex flex-col md:flex-row'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select onChange={handleChange} defaultValue={'created_at_desc'} id='sort_order' className='border rounded-lg p-3'>
                        <option value={'regularPrice_desc'}>More expensive to cheaper</option>
                        <option value={'regularPrice_asc'}>Cheaper to more expensive</option>
        ...
        <div className="flex-1">
            ...
            <div className="p-7 flex flex-wrap gap-4">{!loading && listings.length === 0 && (<p className='text-xl text-slate-700'>No listing found!</p>)}
